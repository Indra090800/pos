    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown"><a href="#"
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="#"
                    class="dropdown-item has-icon text-danger" onclick="event.preventDefault(); document.getElementById('logout').submit()">
                    <i class="fas fa-sign-out-alt"></i> Logout
                </a>
                <form id="logout" action="{{ route('logout') }}" method="POST" class="d-none">@csrf</form>
            </div>
        </li>
    </ul>
</nav>
